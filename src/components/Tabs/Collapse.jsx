            ...
            <div>
                <Collapse isOpen={isOpen}>
                    <div className='collapsecard'>
                        {Array.isArray(multipleChoiceArray) && multipleChoiceArray.map((elem, index) => {
                            return (
                                <Row key={index}>
                                    <Col lg="0">
                                        <IconButton>
                                    ...
                                    <Col lg="10">
                                        <FormGroup>
                                            <Input
                                                className={indexOfNewFieldAdded === elem.id ? "input" : "inputfocus"}
                                                ...
                                                onClick={(e) => {
                                                    ...
                                                    function lastIndexCmp() {
                                                        const obj = multipleChoiceArray[multipleChoiceArray.length - 1]
                                                        if (obj.id)
                                                            return (obj.id)
                                                        else
                                                            return (null)
